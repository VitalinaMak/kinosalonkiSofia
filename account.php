        ...
        <div class="profile info">
            ...
            <form id="profile" method="post" action="changeInfo.php"  enctype="multipart/form-data">
                ...
                <div class="passwordReset">
                    ...
                    <input type="password" id="oldPassword-input" name="oldPassword" value="" placeholder="Vanha salasana" readonly required>
                </div>
                ...
                <div class="passwordReset">
                    ...
                    <input type="password" id="newPassword-input" name="newPassword" value="" placeholder="Uusi salasana" readonly required>
                </div>
                ...
                <div class="passwordReset">
                    ...
                    <input type="password" id="newPasswordRepeat-input" name="newPasswordRepeat" value="" placeholder="Toista uusi salasana" readonly required>
                </div>
