<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if ($user && password_verify($password, $user->password_hash)) {
            ...
            header("Location: " . ($user->id == 1 ? "ADMIN/ad_account.php" : "USER/account.php"));
            exit();
        } else {
    ...
    <div class="wrapper">
        ...
        <form class="login" method="POST" action="" id="login">
            ...
            <div>
                ...
                <input type="email" id="email-input" name="email" placeholder="Sähköpostiosoite" value="testi2@mail.com" required>
            </div>
            <div>
